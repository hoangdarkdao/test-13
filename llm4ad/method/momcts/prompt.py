...
class MOMCTSPrompt:
    ...
    @classmethod
    def get_prompt_i1(cls, task_prompt: str, template_function: Function, long_term_guide: str = None):
        # template
...
Check syntax, code carefully before returning the final function. Do not give additional explanations.'''
    ...
    @classmethod
    def get_prompt_e1(cls, task_prompt: str, indivs: List[Function], template_function: Function, long_term_guide: str = None):
        for indi in indivs:
...
Check syntax, code carefully before returning the final function. Do not give additional explanations.'''
    ...
    @classmethod
    def get_prompt_e2(cls, task_prompt: str, indivs: List[Function], template_function: Function, long_term_guide: str = None):
        for indi in indivs:
            assert hasattr(indi, 'algorithm')
        # template
        temp_func = copy.deepcopy(template_function)
    ...
    @classmethod
    def get_prompt_m1(cls, task_prompt: str, indi: Function, template_function: Function, long_term_guide: str = None):
        assert hasattr(indi, 'algorithm')
    ...
    @classmethod
    def get_prompt_m2(cls, task_prompt: str, indi: Function, template_function: Function, long_term_guide: str = None):
        assert hasattr(indi, 'algorithm')
    ...
    @classmethod
    def get_prompt_s1(cls, task_prompt: str, indivs: List[Function], template_function: Function, long_term_guide: str = None):
        for indi in indivs:
            assert hasattr(indi, 'algorithm')
        ...
        if long_term_guide is not None:
            prompt_content = f'''{task_prompt}
            I have {len(indivs)} existing algorithms with their codes as follows:
            {indivs_prompt}
